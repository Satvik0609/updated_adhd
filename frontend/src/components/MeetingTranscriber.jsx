...
//         // Double-check file before sending
//         if (file.size === 0) {
...
//                     a.href = url;
//                     a.download = `${
//                       inputType === "youtube" ? "youtube" : "media"
...
//                           <div style={{ fontWeight: 600 }}>{ev.bullet || "Related point"}</div>
//                           {typeof ev.startIndex === "number" && typeof ev.endIndex === "number" && (
//                             <div style={{ fontSize: "0.85rem", color: "#6b7280" }}>chars {ev.startIndex}–{ev.endIndex}</div>
//                           )}
//                           {ev.quote && (
//                             <blockquote style={{ margin: "6px 0", paddingLeft: 12, borderLeft: "3px solid #e5e7eb", color: "#374151" }}>
//                               “{ev.quote}”
//                             </blockquote>
//                           )}
//                         </li>
...
//                     </ul>
//                     <p>
//                       Please try with a different file or check the file
//                       quality.
//                     </p>
//                   </div>
//                 </div>
